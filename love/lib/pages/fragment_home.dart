                ...
                child: Column(children: [
                  ...
                  BrnRadioInputFormItem(
                    ...
                    onChanged: (oldValue, newValue) {
                      setState(() {
                        _countDownType =
                            newValue == _countDownTypeList[1] ? 1 : 2;
                      });
                    },
                  ),
                  BrnTitleFormItem(
                    ...
                    onTap: () {
                      BrnDatePicker.showDatePicker(
                        ...
                        dateFormat:
                            _countDownType == 1 ? "yyyy-MM-dd" : "MM-dd",
            ...
            actions: <Widget>[
              ...
              TextButton(
                ...
                onPressed: () {
                  ...
                  // 构建请求
                  ApiService.addCountDown(AddCountDownReq(_title, _getTime(),
                          _countDownType, Storage.getSexSync()))
                      .then((value) =>
